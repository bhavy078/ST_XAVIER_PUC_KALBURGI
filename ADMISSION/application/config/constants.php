...
// define('USERNAME_TEXTLOCAL',                            'stjoshep@schoolphins.com');
// define('HASH_TEXTLOCAL',                                '3379348e4273db8d5540aba1f1b1d2fec4916765');
// define('SENDERID_TEXTLOCAL',                            'SJPUCB');	



// paytm
define('PAYTM_ENVIRONMENT', 'TEST'); // PROD
define('PAYTM_MERCHANT_KEY', 'y3MjHXIbt&KjpyGo'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'DbighF99298015484860'); //Change this constant's value with MID (Merchant ID) received from Paytm.
