...
<tbody>
    ...
    <tr>
        <th>
            <input id="subject_name" type="text" name="subject_name[]"  class="form-control   input-sm " placeholder="Enter Language I"  autocomplete="off" />
        </th>
        ...
        <td><input type="number" onkeypress="return isNumber(event)"  id="subject_obtained" type="text" name="subject_obtained[]" class="form-control   input-sm obtnained_mark" placeholder="Enter First Term Mark" autocomplete="off"  /></td>
    ...
    <tr>
        <th>
            <input id="subject_name" type="text" name="subject_name[]"  class="form-control   input-sm text-uppercase" placeholder="Language II" autocomplete="off" /></th>
        <th><input onkeypress="return isNumber(event)" maxlength="3" id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control  input-sm" value="100" readonly autocomplete="off"/></th>
        <td><input type="number" onkeypress="return isNumber(event)"  id="subject_obtained" type="text" name="subject_obtained[]" class="form-control  input-sm obtnained_mark" placeholder="Enter First Term Mark" autocomplete="off" /></td>
        <!-- <td><input maxlength="3" onkeypress="return isNumber(event)" id="obt_mark_9_std" type="text" name="obt_mark_9_std[]" class="form-control  input-sm" placeholder="Enter 9th Standard Mark" autocomplete="off"  required/></td> -->
    </tr>
    <tr>
        <th>
            <input id="subject_name" type="text" name="subject_name[]"  class="form-control   input-sm" placeholder=" Enter Subject Name(HISTORY, CIVICS AND GEOGRAPHY)"  autocomplete="off" />
        </th>
        <th><input onkeypress="return isNumber(event)" maxlength="3" id="subject_max_mark" type="text" name="subject_max_mark[]" class="form-control  input-sm" value="100" readonly autocomplete="off"/></th>
        <td><input type="number" onkeypress="return isNumber(event)" id="subject_obtained"  type="text" name="subject_obtained[]" class="form-control  input-sm obtnained_mark" placeholder="Enter First Term Mark" autocomplete="off" /></td>
        <!-- <td><input maxlength="3" onkeypress="return isNumber(event)" id="obt_mark_9_std" type="text" name="obt_mark_9_std[]" class="form-control  input-sm" placeholder="Enter 9th Standard Mark" autocomplete="off"  required/></td> -->
    ...
    <tr>
        <th>
            <select class="form-control " id="subject_name" name="subject_name[]" autocomplete="off" >
